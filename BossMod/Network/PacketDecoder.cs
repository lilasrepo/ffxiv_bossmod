...
public abstract unsafe class PacketDecoder
{
    ...
    {
        // TODO(api12): DeepDungeon{Status,Ban,Danger}.FloorEffectUI is a game-7.5 column not present in TC 7.1.
        return new($"Layout={p->LayoutInitType}, status={p->StatusId}, ban={p->BanId}, danger={p->DangerId}");
    }
