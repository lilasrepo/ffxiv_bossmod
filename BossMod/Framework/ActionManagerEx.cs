    ...
    private ActionID NormalizeActionForQueue(ActionID action)
    {
        switch (action.Type)
        {
            ...
            case ActionType.General:
                ...
                else if (action == ActionDefinitions.IDGeneralSprint && GameMain.Instance()->CurrentTerritoryIntendedUseId == 60 /* TerritoryIntendedUse.CosmicExploration; API12 has no enum */)
                {
